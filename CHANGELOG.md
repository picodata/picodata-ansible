...
- именами инстансов генерируются автоматически
...
- добавлена отдельный тег `expand` для расширения кластера
- добавлена тег `rebootstrap` для переинициализации инстанса
- добавлена возможность запуска файла с набором sql-команд непосредственно после деплоя кластера
