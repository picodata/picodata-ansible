...
- добавлена возможность работы с автосгенерированными именами инстансов
- добавлен отдельный тег для создания report-файлов
...
- добавлен флаг `deny_restart` запрещающий перезапуск инстансов при изменении конфигурации
